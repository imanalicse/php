...
class DateTimeSlotUtils
{
   public static function getDateSlotInterval($interval, $start_time, $end_time): array
    ...
    public static function  getMonthlyDateRanges($start_date, $end_date): array
    {
        ...
        $slots = self::getDateSlotInterval('1 month', $start_date, $end_date);
...
$end_date = '2022-02-05';
$monthly_date_ranges = DateTimeSlotUtils::getMonthlyDateRanges($start_date, $end_date);
echo "<pre>";
