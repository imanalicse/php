...
<head>
	<title></title>
	<style type="text/css">.form-wrapper {
     width: 100%;
     }
.inline-row.top-row-form {
    padding-top: 20px;
}
.yes-no-box{
   padding-top:18px;
...
.survey-form-footer.continue-btn-wrap {
    padding-top: 21px;
    padding-left: 0px;
}
.survey-form-header {
...
.csp-popup .texarea-box label.error {
    margin-top: -10px;
}
label.cngratulation-text {
    font-weight: 600;
    color: #002f55;
...
<div class="modal-dialog email-popup-model view-popupimage csp-popup">
<div class="modal-content portrait-content">
<div class="modal-body">
<form action="/products/surveyProcessForm" id="student_survey_form" method="post" novalidate="">
<div class="form-wrapper from-serv-box">
<div class="survey-form-header">
<div class="survey-brand-logo"><img alt="logo" src="/img/servey/msu/servey-logo5.png" /></div>

<div class="survey-brand-title">
<h1>MICHIGAN STATE UNIVERSITY<br />
2021 SPRING COMMENCEMENT</h1>
</div>
</div>
...
<input name="data[StudentSurvey][extra][after_graduation_plan][radio_selected_index]" class="radio_selected_index" type="hidden" value="" />
